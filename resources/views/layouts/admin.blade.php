...
<head>
  ...
  @endif
  <link href="{{ asset('public/admin/css/bootstrap-datetimepicker.css') }}">
  ...
  <link href="{{ asset('public/admin/css/daterangepicker.css') }}" rel="stylesheet" /> 
...
<body class="c-app">
  ...
  <script src="{{ asset('public/admin/js/common-lanci.js') }}"></script>
  <script>
    $(function() {
