        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.press.update', [$press->id]) }}" enctype="multipart/form-data"
                ...
                <div class="form-group  col-md-6 col-xs-12">
                    ...
                    <div id="press-{{$press->id}}" style="margin-top:15px;max-height:100px;">
                        <img src="{{ $press->photo }}" alt="" style="height: 5rem;">
                    </div>
                    @error('photo')
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                            name="link" id="link" value="{{ old('title', $press->link) }}" required>
                        @if ($errors->has('link'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                            name="title" id="title" value="{{ old('title', $press->title) }}" required>
                        @if ($errors->has('title'))
                            <div class="invalid-feedback">
                                {{ $errors->first('title') }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description"
                            id="description">{{ old('description', $press->description) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" {{ $press->is_show == 1 ? "checked" : "" }} type="checkbox" name="is_show"
                                value="{{ $press->is_show }}" id="is_show">
