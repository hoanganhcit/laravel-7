...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data" class="row">
            @method('PUT')
            @csrf
            <div class="form-group  col-md-6 col-xs-12">
                ...
                <div id="post-{{$post->id}}" style="margin-top:15px;max-height:100px;">
                    <img src="{{ $post->photo }}" alt="" style="height: 5rem;">
                </div>
                  @error('photo')
            ...
            <div class="form-group  col-md-6 col-xs-12">
                ...
                <div class="form-group mt-4">
                    <div class="form-check ">
                        <input class="form-check-input" type="checkbox" id="is_feature" onclick="isFeature()" {{$post->is_feature ? 'checked' : ''}}>
                        <label class="form-check-label" for="is_feature">
                            Bài viết nổi bật
                        </label>
                        <input type="hidden" name="is_feature" value="{{$post->is_feature}}" id="val_isfeature">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content" style="min-height: 600px">{{ old('content', $post->content) }}</textarea>
