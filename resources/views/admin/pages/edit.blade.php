...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.update", [$page->id]) }}" enctype="multipart/form-data" class="row">
            @method('PUT')
            @csrf
            ...
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" name="content" id="content" style="min-height: 600px">{{ old('content', $page->content) }}</textarea>
