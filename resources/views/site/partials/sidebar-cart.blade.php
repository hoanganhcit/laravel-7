<div class="canvas-sidebar cart-canvas">
    ...
    <div class="card border-0 pt-4 pb-7 h-100">
        ...
        <div class="card-header bg-transparent p-0 mx-4">
            <h3 class="fs-24 mb-5">
                Giỏ Hàng
            </h3>
        ...
        <div class="card-body px-4 pt-4 overflow-y-auto" id="cart-items-container">
            @include('site.partials._cart_items', ['cart' => session()->get('cart', [])])
        </div>
        <div class="card-footer mt-auto border-0 bg-transparent px-4 pb-0 pt-5">
