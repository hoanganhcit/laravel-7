...
<section>
    <div class="container container-xl">
        ...
        <div class="row">
            <div class="col-lg-5 mb-8 mb-lg-0" data-animate="fadeInLeft">
                <div class="card border-0 hover-shine hover-zoom-in banner banner-04">
                    <div class="card-img bg-img-cover-center" style="background-image: url('{{ asset('public/site/images/banner-32.jpg') }}');">
                    </div>
                    <div class="card-img-overlay d-inline-flex flex-column justify-content-end p-8">
                        <h6 class="card-subtitle mb-1 text-white  fs-48 lh-166 font-weight-normal">
                            Trao quyền cho bản thân</h6>
                        <h3 class="card-title fs-40 lh-13 text-white mb-6">Có được làn da bạn mong muốn</h3>
                        <div>
                            <a href="#" class="fs-16 font-weight-600 btn text-secondary hover-white bg-white bg-hover-secondary shadow-1">Explore
                                More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 mb-3" data-animate="fadeInRight">
